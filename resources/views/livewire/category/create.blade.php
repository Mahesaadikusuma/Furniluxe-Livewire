                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                ...
                                file
                                <input type="file" wire:model='thumbnail' wire:ignore
                        ...
                        <div class="flex items-center  border-t border-gray-200 rounded-b dark:border-gray-600">
                            ...
                            <div wire:loading.delay.longer wire:target="remove">
                                Removing post...
                            </div> --}}

                            {{-- <button type="submit" wire:loading.attr="disabled"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <span wire:loading.remove wire:click='remove'>I accept</span>
                            </button>
                            <span wire:loading.delay.longer wire:target="store">Submitting...</span> --}}

                            <button type="submit" wire:click="remove" wire:loading.attr="disabled"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                ...
                                <span wire:loading.remove wire:target="remove">I accept</span>
                                ...
                            </button>
