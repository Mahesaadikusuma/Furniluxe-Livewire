<div x-data="{ open: true }">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            @endif
            <livewire:pages.admin.permission.create />
                    ...
                    <tr wire:key="{{ $item->id }}"
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <livewire:pages.admin.permission.edit :permission="$item" :key="$item->id" />
                                <livewire:pages.admin.permission.delete :permission="$item" :key="$item->id" />
